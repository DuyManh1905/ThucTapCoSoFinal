...
public class CategoryController {
	...
	public String addCategory(Model model, @Validated @ModelAttribute("Category") Category category,
	...
	public String update(@PathVariable("id") Long id, @Validated @ModelAttribute("Category") Category category,
			RedirectAttributes redirectAttributes) {
		if (categoryService.existsById(id)) {
			try {
				Category category1 = categoryService.updateCategory(category);
				redirectAttributes.addFlashAttribute("successMessage",
						"Loại sản phẩm " + category1.getCode() + " được cập nhật thành công");
