...
import com.project.Shop.dto.Bill.BillDetailDtoInterface;
import com.project.Shop.dto.Bill.BillDetailProduct;
import com.project.Shop.dto.Bill.BillDto;
import com.project.Shop.dto.Bill.BillDtoInterface;
import com.project.Shop.dto.Bill.SearchBillDto;
...
public class BillController {
	...
	public String getBill(Model model, @RequestParam(name = "page", defaultValue = "0") int page,
		...
		if (ngayTaoStart != null || ngayTaoEnd != null || maDinhDanh != null || trangThai != null || loaiDon != null
				|| hoVaTen != null || soDienThoai != null) {
			...
			Bill = billService.searchListBill(maDinhDanh.trim(), convertedNgayTaoStart, convertedNgayTaoEnd, trangThai,
					loaiDon, soDienThoai.trim(), hoVaTen.trim(), pageable);
		} else {
	...
	public String updateBillStatus2(Model model, @PathVariable Long billId, @RequestParam String trangThaiDonHang,
	...
	public void exportBill(HttpServletResponse response, @RequestParam(name = "page", defaultValue = "0") int page,
			@RequestParam(name = "sort", defaultValue = "createDate,desc") String sortField,
			@RequestParam(name = "ngayTaoStart", required = false) @DateTimeFormat(pattern = "yyyy-MM-dd") Date ngayTaoStart,
			@RequestParam(name = "ngayTaoEnd", required = false) @DateTimeFormat(pattern = "yyyy-MM-dd") Date ngayTaoEnd,
		...
		String exportUrl = uriBuilder.path("/export-bill").queryParam("page", page).queryParam("sort", sortField)
				.queryParam("ngayTaoStart", ngayTaoStart).queryParam("ngayTaoEnd", ngayTaoEnd).toUriString();
