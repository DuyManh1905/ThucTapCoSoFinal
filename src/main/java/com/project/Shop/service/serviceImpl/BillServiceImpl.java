...
import com.project.Shop.entity.BillDetail;
...
import com.project.Shop.repository.Specification.BillSpecification;
import com.project.Shop.service.BillService;
import com.project.Shop.utils.UserLoginUtil;
...
public class BillServiceImpl implements BillService {
    ...
    public String exportPdf(HttpServletResponse response, Long maHoaDon) throws DocumentException, IOException {
        ...
        String htmlContent = getHtmlContent(maHoaDon);// set pdf
    ...
    public String getHtmlContent(Long maHoaDon) {
        ...
        String htmlContent = "<html xmlns:th=\"http://www.thymeleaf.org\">\n" +
                ...
                "<h3 style=\"text-align: center\"> Học Viện Công nghệ Bưu chính Viễn thông</h3>\n" +
                "<h3 style=\"text-align: center\">Km10, Đường Nguyễn Trãi, Q.Hà Đông, Hà Nội</h3>\n\n" +
